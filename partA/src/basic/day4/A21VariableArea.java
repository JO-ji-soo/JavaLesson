...
public static void main(String[] args) {
    ...
    int a =23;    //2. main 범위에서 사용되는 변수

    for(int i=0;i>10;i++){     //3. 특정블럭(for) 범위에서 사용되는 변수 - i
...
/*
 * 진도를 이후에 나갈 내용입니다. main 메소드에 static 은 static 까지만 서로 사용할 수 있습니다.
 *                                           static 이 아닌 클래스 선언 변수는 사용 못함.
 */
