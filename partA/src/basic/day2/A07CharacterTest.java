...
public class A07CharacterTest {
	...
	public static void main(String[] args) {
		...
		//문자와 코드 정수값 (다국어문자가 아닌 영문자,숫자, 기호는 기본적인 아스키코드 사용)
		...
		System.out.println("////////int와 char 형식 변수 사이의 캐스팅/////////");
		...
		System.out.println("temp변수 문자 ="+temp);
		...
		System.out.println("변경된 c3 문자의 코드값: " + (int)c3);		//int를 char로 강제 캐스팅. '갂'
