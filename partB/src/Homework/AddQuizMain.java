...
public class AddQuizMain {
    public static void main(String[] args) {
        ...
        int end=99; int start=11;
        Scanner scanner = new Scanner(System.in);   //키보드 입력 객체 생성
        System.out.println("덧셈 10문제 퀴즈를 시작합니다.");
        for(int i = 0; i < 10; i++) { 
            int data1 = (int)(Math.random()*(end-start+1))+start;    //11~99 사이의 무작위 숫자 1개 저장
            int data2 = (int)(Math.random()*(end-start+1))+start;    //11~99 사이의 무작위 숫자 1개 저장
        ...
        for(int i = 0; i < addQuizArray.length; i++) {
            ...
            System.out.println((i + 1) + "번.\t" + addQuiz.getData1() + "+" + addQuiz.getData2() + "\t\t"
