...
public class A30HashCodeTest {
    public static void main(String[] args) {
        ...
        //hashcode는 참조값(식별값)을 만드는 '해쉬함수'로 생성된 결과입니다.
        System.out.println(iArray); //배열의 식별값을 보여줍니다. (16진수)
        System.out.println(iArray.hashCode()); //해쉬코드값을 가져옵니다.
        System.out.println(Integer.toHexString(iArray.hashCode())); //10진수를 16진수로 변환
        
        iArray[3]=99;
        System.out.println("초기 해시코드:" +iArray.hashCode());
        System.out.println(Integer.toHexString(iArray.hashCode()));
 ...
 * 객체를 메모리에 저장했어요. ---> 초기에 저장한 데이터를 바꿀 수 있다.(배열)
 *                           ---> 초기에 저장한 데이터를 바꿀 수 없다.(String)
 */
