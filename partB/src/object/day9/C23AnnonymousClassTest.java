...
//익명의 객체 - 추상클래스 상속 또는 인터페이스 구현 할 때
...
public class C23AnnonymousClassTest {
  public static void main(String[] args) {
     ...
     //재정의 해야하는 메소드가 1개 입니다. BeAble 인터페이스의 추상메소드가 1개 입니다.
...
//함수형 인터페이스 정의     (참고)function 키워드는 c언어,자바스트립트에서 함수 정의에 사용
...
//(참고)자바 라이브러리에는 인자의 형식과 개수와 리턴 타입 등 여러 유형에 따라 Consumer, Producer(자바8까지 이후 Supplier), Function, Predicate 등의
